...
import banner from "../../../../public/nentrangchu.png";
...
function StudentHomePage() {
  ...
  async function handleCourseNavigate(getCurrentCourseId) {
    ...
    if (!getCurrentCourseId || !studentId || studentId.length !== 24) {
    ...
    try {
      ...
      // Có thể hiện toast thông báo người dùng
    }
  }
    ...
    <div className="min-h-screen bg-white">
      <section className="flex flex-col lg:flex-row items-center justify-between py-8 px-4 lg:px-8">
        <div className="lg:w-1/2 lg:pr-12">
          <h1 className="text-4xl font-bold mb-4">"Kiến thức mới, cơ hội mới, thành công mới."</h1>
          <p className="text-xl">
